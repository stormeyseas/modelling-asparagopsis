...
#            t = case_when(t > 365 ~ t-365, T ~ t),
#            start = as.integer(lubridate::month(parse_date_time(x = start, orders = "j"))+1),
#            start = case_when(start == 13 ~ 1, month == 14 ~ 2, T ~ start))
# })
# taxiformis_lims <- map_dfr(cell_growth_lims_fnms, function(fnm) {
#   fnm %>% 
#     arrow::read_parquet() %>% 
