...
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Darwin"]/sum(totals$cells), 1)`% of cells using data from Darwin, 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Kangaroo Island"]/sum(totals$cells), 1)`% using data from Kangaroo Island, 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Maria Island"]/sum(totals$cells), 1)`% using data from Maria Island, 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "North Stradbroke Island"]/sum(totals$cells), 1)`% from North Stradbroke Island, 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Port Hacking"]/sum(totals$cells), 1)`% using data from Port Hacking, 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Rottnest Island"]/sum(totals$cells), 1)`% using data from Rottnest Island, and 
`r round(100*refstation_cell_match$nc[refstation_cell_match$StationName == "Yongala"]/sum(totals$cells), 1)`% using data from Yongala. 
